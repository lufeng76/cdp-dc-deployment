...
kinit -kt hdfs.keytab hdfs/ccycloud-1.feng.root.hwx.site@FENG.COM
hdfs dfs -mkdir /data
...
[source,bash]
beeline -u "jdbc:hive2://ccycloud-1.feng.root.hwx.site:10099/default;principal=etl_user/ccycloud-1.feng.root.hwx.site@FENG.COM"
